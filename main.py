...
for i in range(1, pages + 1):
    ...
    j = 3
    for item in paper:
        xpath = """/html/body/div[5]/div/div/div/div[3]/div/xpl-root/div/xpl-search-results/main/div[2]/div[2]/xpl-results-list/div[%s]/xpl-results-item/div[1]/div[1]/div[2]/h2"""%(j)
